...
B3.1 至 B3.3 的文件、品牌/分类与 ADM-05/06 证据继续有效；B4 已交付 Product/SKU，B5 已交付 Banner/库存，B6 已交付匿名 Store API、MP-01 至 MP-06，B7 已交付消费者身份、资料手机号、归因/服务代理、同步注销及小程序身份页面，B8 已交付收藏、服务端购物车、游客 merge、地址、小程序购物入口和最终双绿。B9.0 已完成契约、0002 加法索引、静态交互和受控远端迁移验收；B9.1 已交付 Store Checkout 报价 repository/module、300 秒 HMAC 凭证和对应数据库/API 验收，现以 `P0=0/P1=0` 暂停。B9.2-B9.5 尚未开始，支付继续延后到 B10。
