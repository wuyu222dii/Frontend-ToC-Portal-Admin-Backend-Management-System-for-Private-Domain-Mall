...
B3.1 至 B3.3 的文件、品牌/分类与 ADM-05/06 证据继续有效；B4 已交付 Product/SKU，B5 已交付 Banner/库存，B6 已交付匿名 Store API、MP-01 至 MP-06，B7 已交付消费者身份、资料手机号、归因/服务代理、同步注销及小程序身份页面。B8.0 已冻结收藏、服务端购物车、游客合并和地址契约/静态原型；B8.1 已交付收藏 repository/API、共享限流和回滚测试，B8.2-B8.5、订单、结算和支付尚未开始。
