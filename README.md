...
B3-B12 与 B13.0-B13.8 的历史证据继续以各阶段记录为准。B13.9 按 2026-09-05 已批准的精简门禁收口：最终 SHA `250cbb824ad11f4b0e11338c19494655ec384ff6` 的 development migration `33952031401` 与 rollback-only smoke `33952283771` 同 SHA、依次成功；未把未运行的全仓回归或纵向测试记为通过。B13 development `GO`，CH-029 已失效；B14.1 的只读经营分析仓储和五个 Admin API 已完成计划内定向验证并暂停复审，B14.2 前端尚未准入。
