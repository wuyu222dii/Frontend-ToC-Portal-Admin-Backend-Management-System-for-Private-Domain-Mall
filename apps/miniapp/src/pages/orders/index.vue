...
.orders-tab--active { border-bottom-color: var(--qx-store-brand) !important; color: var(--qx-store-brand-strong); font-weight: 600; }
.orders-page__body { display: grid; gap: 16rpx; padding: 20rpx 20rpx calc(42rpx + env(safe-area-inset-bottom)); }
.orders-notice { display: block; padding: 18rpx 20rpx; border-radius: 16rpx; color: var(--qx-store-warning); background: #fff5df; font-size: 20rpx; line-height: 1.55; }
.order-card { min-width: 0; overflow: hidden; border-radius: var(--qx-store-radius, 16rpx); background: var(--qx-store-surface); }
...
.order-card__number { font-size: 21rpx; font-weight: 600; }
.order-card__date { margin-top: 6rpx; color: var(--qx-store-muted); font-size: 17rpx; }
.order-card__status { flex: 0 0 auto; color: var(--qx-store-brand-strong); font-size: 22rpx; font-weight: 600; }
...
.order-card__amount { min-width: 0; font-size: 22rpx; font-weight: 600; overflow-wrap: anywhere; }
.order-card__footer button { min-height: 58rpx; padding: 10rpx 20rpx; border: 1px solid var(--qx-store-brand) !important; border-radius: var(--qx-store-radius, 16rpx); color: var(--qx-store-brand); background: #ffffff; font-size: 19rpx; }
.orders-load-more { width: 100%; min-height: 76rpx; border: 1px solid var(--qx-store-line) !important; border-radius: 16rpx; color: var(--qx-store-brand); background: #ffffff; font-size: 21rpx; }
