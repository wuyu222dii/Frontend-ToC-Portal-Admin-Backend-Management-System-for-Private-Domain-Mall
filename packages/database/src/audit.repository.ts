...
const AUDIT_RESULT_CODE = new Set(['OK', ...Object.keys(APPLICATION_ERROR_HTTP_STATUS),
  'OFFLINE_RECOVERY_LOCKED', 'OFFLINE_RECOVERY_AUTH_FAILED', 'OFFLINE_RECOVERY_ACTOR_FORBIDDEN',
  'OFFLINE_RECOVERY_TERMINAL', 'OFFLINE_RECOVERY_EXPIRED', 'OFFLINE_RECOVERY_TARGET_CHANGED',
  'OFFLINE_RECOVERY_APPROVER_INVALIDATED', 'OFFLINE_RECOVERY_TARGET_UNAVAILABLE',
  'OFFLINE_RECOVERY_ALREADY_ACTIVE', 'OFFLINE_RECOVERY_REQUESTED', 'OFFLINE_RECOVERY_UNAVAILABLE',
  'OFFLINE_RECOVERY_ALREADY_DECIDED', 'OFFLINE_RECOVERY_NOT_PENDING', 'OFFLINE_RECOVERY_REJECTED',
  'OFFLINE_RECOVERY_APPROVED', 'OFFLINE_RECOVERY_VERSION_CONFLICT', 'OFFLINE_RECOVERY_NOT_APPROVED',
  'OFFLINE_RECOVERY_EXECUTED',
]);
