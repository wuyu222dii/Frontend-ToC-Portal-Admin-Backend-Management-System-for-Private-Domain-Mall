export const APPLICATION_ERROR_HTTP_STATUS = {
  ...
  STATE_CONFLICT: 409,
  SHIPMENT_STATE_CONFLICT: 409,
  ORDER_NOT_RECEIVABLE: 409,
  ...
  AFTERSALE_PREVIEW_EXPIRED: 409,
  AFTERSALE_PREVIEW_MISMATCH: 409,
  AFTERSALE_REQUOTE_REQUIRED: 409,
  ...
  RETURN_ADDRESS_NOT_CONFIGURED: 422,
  ACTIVE_AFTERSALE_BLOCKS_SHIPMENT: 422,
  SHIPMENT_ITEMS_MISMATCH: 422,
  ...
  WITHDRAWAL_BALANCE_INSUFFICIENT: 422,
  WITHDRAWAL_MINIMUM_NOT_MET: 422,
...
export const APPLICATION_ERROR_PUBLIC_MESSAGE: Readonly<Record<ApplicationErrorCode, string>> = {
  ...
  BANK_ACCOUNT_REQUIRED: 'An active bank account is required',
  WITHDRAWAL_BALANCE_INSUFFICIENT: 'The available balance is insufficient',
  WITHDRAWAL_MINIMUM_NOT_MET: 'The withdrawal amount is below the current minimum',
  WITHDRAWAL_IN_PROGRESS: 'Another withdrawal is already in progress',
