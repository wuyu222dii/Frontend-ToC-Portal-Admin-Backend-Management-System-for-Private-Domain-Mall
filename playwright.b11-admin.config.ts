...
export default defineConfig({
  testDir: './tests/e2e',
  testMatch: 'b11-admin-fulfillment.spec.ts',
  fullyParallel: true,
  reporter: 'line',
  outputDir: 'test-results/b11-admin-fulfillment',
  projects: [
  ...
  webServer: {
    command: 'pnpm --filter @qingxu/admin-web exec vite --host 127.0.0.1 --port 5275',
    port: 5275,
