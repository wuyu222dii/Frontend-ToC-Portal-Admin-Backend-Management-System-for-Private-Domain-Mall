...
export default defineConfig({
  testDir: './tests/e2e',
  testMatch: 'b12-miniapp-aftersales.spec.ts',
  fullyParallel: true,
  reporter: 'line',
  outputDir: 'test-results/b12-miniapp-aftersales',
  projects: [
  ...
  webServer: {
    command: 'pnpm --filter @qingxu/miniapp exec uni -p h5 --host 127.0.0.1 --port 5277',
    port: 5277,
