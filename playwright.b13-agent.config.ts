...
export default defineConfig({
  testDir: './tests/e2e',
  testMatch: 'b13-agent-workbench.spec.ts',
  fullyParallel: true,
  reporter: 'line',
  outputDir: 'test-results/b13-agent-workbench',
  projects: [
  ...
  webServer: {
    command: 'pnpm --filter @qingxu/agent-web exec vite --host 127.0.0.1 --port 5279',
    port: 5279,
