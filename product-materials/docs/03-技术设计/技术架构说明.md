...
> 技术基线：v2.4.7 / CH-020（2026-08-28）；状态：B0-B8 development 已完成，B8 最终 SHA 已同 SHA 双绿且 CH-017 已失效；CH-019/CH-020 已批准，B9.0 与 B9.1 已完成，B9.1 经三路独立复审达到 `P0=0/P1=0` 后暂停。B9.2-B9.5 未开始，等待用户批准 B9.2；仅允许 Mock Provider 和脱敏 development，staging/production 未批准
