...
> 技术基线：v2.4.4 / CH-014（2026-08-25）；状态：B0-B5 development 已完成，B6.1 Store 公开 API 已完成本地及受控 Supabase development rollback-only 验收并暂停，B6.2 工程页面尚未开始，staging/production 未批准
...
- B6.1 已暂停，B6.2 MP-01 至 MP-05 工程页面未开始。B6.4 尚未接入本批真实 H5 纵向、普通 CI 或 Supabase workflow，不得把当前结果描述为 B6 最终 development `GO`。
...
- CH-014 实测为 172 paths / 196 operations / 196 unique operationId / 312 schemas / 691 schema refs / 2,577 local refs / 0 dangling refs；Store SKU/Product 售罄布尔投影、COMPREHENSIVE/HOT/NEWEST/价格排序、商品名搜索、无分页公开品牌/分类、首页四区状态与 HMAC IP 限流已纳入 B6.0 契约门禁。B6.1 公开 API 已按该契约实现并完成本批验收后暂停；B6.2 工程页面未开始。
