...
> 技术基线：产品/API 为 v2.4.10 / CH-026；数据库修复 CH-023（2026-08-30）继续有效。状态：B0-B11 development 已完成并维持 `GO`；B12.0 精确 SHA 三项远端门禁与 CH-027 已闭合。B12.1-B12.5 已完成并在 B12.5 验收后暂停；B12.5 通过 generated contracts 和严格解码器接入 MP-13/14、ADM-12/13/16，并建立五视口 E2E。B12.6 尚未开始，尚无 B12 最终远端双绿证据，B12 development 尚未 `GO`，CH-027 仍有效。真实客户数据、staging、production、真实微信退款与真实物流均为 `NO-GO`
...
- B12.0 精确 SHA `03a1e9f98bea0926887fb68354ca602566148f6a` 已依次通过普通 CI、Supabase development migration 和 rollback-only smoke，CH-027 已批准。B12.1-B12.5 已实现并在 B12.5 验收后暂停；B12.4 已交付普通退款/金额补偿 preview-confirm、Mock Provider/Inbox/Worker、稳定失败重试和库存/订单/佣金钱包收敛，B12.5 已交付 MP-13/14、ADM-12/13/16、generated contracts、严格响应解码器及五视口 E2E。B12.6 尚未开始。
