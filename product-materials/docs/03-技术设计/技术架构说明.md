...
- CH-018 专项实测为 173 paths / 198 operations / 198 unique operationId / 323 schemas / 701 schema refs / 2,653 local refs / 0 dangling refs，Redocly 0 warning。收藏失效投影、购物车 selected/五状态/merge、HASH_ONLY、no-store 与登录后 120/60 fail-closed 限流已实现；B8.3 已实现地址 AES-256-GCM/字段 AAD、掩码、所有权 404、默认地址原子切换/提升与 If-Match，并完成后暂停，B8.4 未准入。
