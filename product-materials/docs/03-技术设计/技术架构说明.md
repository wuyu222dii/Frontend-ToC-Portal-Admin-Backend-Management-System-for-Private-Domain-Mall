...
> 技术基线：v2.4.5 / CH-016（2026-08-27）；状态：B0-B6 development 已完成，CH-015/CH-016 已批准；B7.0-B7.3 已完成并按批暂停，B7.3 `P0=0/P1=0`，B7.4 未准入；仅允许 Mock Provider 和脱敏 development，staging/production 未批准
...
- CH-016 专项实测为 173 paths / 197 operations / 197 unique operationId / 320 schemas / 699 schema refs / 2,617 local refs / 0 dangling refs，Redocly 0 warning。三份法律文本、Store/Admin audience 隔离、服务端 Provider 选择、If-Match、候选 token/目标、服务代理最小投影和同步注销已纳入 B7.0 契约门禁；B7.1 已完成 Store 身份与会话，B7.2 已完成资料与账户手机号，B7.3 已完成可选认证、30 分钟候选、登录迁移、并发确认/拒绝、长期绑定与服务代理最小投影，full/rollback 门禁及退出审查均为 `P0=0/P1=0`。B7.4 尚未准入。
