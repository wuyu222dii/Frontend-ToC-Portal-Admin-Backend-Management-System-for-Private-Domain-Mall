...
> 技术基线：v2.4.5 / CH-016（2026-08-27）；状态：B0-B6 development 已完成，CH-015/CH-016 已批准；B7.1 后端身份与会话批次已完成并暂停、`P0=0/P1=0`，B7.2 未准入；仅允许 Mock Provider 和脱敏 development，staging/production 未批准
...
- CH-016 专项实测为 173 paths / 197 operations / 197 unique operationId / 320 schemas / 699 schema refs / 2,617 local refs / 0 dangling refs，Redocly 0 warning。三份法律文本、Store/Admin audience 隔离、服务端 Provider 选择、If-Match、候选 token/目标、服务代理最小投影和同步注销已纳入 B7.0 契约门禁；B7.1 已完成 Store 身份与会话、数据库 full/rollback 和安全门禁并暂停，退出审查 `P0=0/P1=0`，B7.2 尚未准入。
