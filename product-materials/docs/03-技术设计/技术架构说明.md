...
> 技术基线：产品/API 为 v2.4.10 / CH-026；数据库修复 CH-023（2026-08-30）继续有效。状态：B0-B11 development 已完成并维持 `GO`；B12.0 精确 SHA 三项远端门禁与 CH-027 已闭合。B12.1-B12.3 后端已完成并在 `P0=0/P1=0` 后逐批暂停，B12.4 尚未开始，B12 development 尚未 `GO`。真实客户数据、staging、production、真实微信退款与真实物流均为 `NO-GO`
...
- B12.0 精确 SHA `03a1e9f98bea0926887fb68354ca602566148f6a` 已依次通过普通 CI、Supabase development migration 和 rollback-only smoke，CH-027 已批准。B12.1-B12.3 已实现并在 `P0=0/P1=0` 后逐批暂停；B12.3 已交付实收验货、证据封存、异常继续退款和退货后拒绝，B12.4 普通退款尚未开始。
