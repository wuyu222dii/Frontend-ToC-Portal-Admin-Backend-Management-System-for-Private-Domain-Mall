...
- B12.0 精确 SHA `03a1e9f98bea0926887fb68354ca602566148f6a` 已依次通过普通 CI、Supabase development migration 和 rollback-only smoke，CH-027 已批准且仍有效。B12.1-B12.6 本地实现与本地验收已完成，覆盖普通退款/金额补偿 preview-confirm、Mock Provider/Inbox/Worker、稳定失败重试、库存/订单/佣金钱包收敛、工程前端、完整真实纵向及精确清理；最终同 SHA 远端双绿待完成。
