...
> 技术基线：v2.4.7 / CH-020（2026-08-28）；状态：B0-B8 development 已完成，B8 最终 SHA 已同 SHA 双绿且 CH-017 已失效；CH-019/CH-020 已批准，当前仅进入 B9.0 契约与前向迁移准入，B9.1 业务代码尚未开始；仅允许 Mock Provider 和脱敏 development，staging/production 未批准
