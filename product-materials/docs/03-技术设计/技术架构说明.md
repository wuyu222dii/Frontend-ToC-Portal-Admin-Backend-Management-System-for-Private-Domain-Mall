...
> 技术基线：v2.4.7 / CH-020（2026-08-28）；状态：B0-B8 development 已完成，B8 最终 SHA 已同 SHA 双绿且 CH-017 已失效；CH-019/CH-020 已批准，B9.0-B9.3 已完成，B9.3 经独立复审达到 `P0=0/P1=0` 后暂停。B9.4-B9.5 未开始，等待用户批准 B9.4；B9 development 尚未 `GO`，仅允许 Mock Provider 和脱敏 development，staging/production 未批准
...
- B5-B8 历史同 SHA 双绿证据继续有效。CH-019 只接续 B9.0-B9.5 脱敏 development 的单人维护补偿控制，B9.5 后自动失效，且不放行 staging/production。
