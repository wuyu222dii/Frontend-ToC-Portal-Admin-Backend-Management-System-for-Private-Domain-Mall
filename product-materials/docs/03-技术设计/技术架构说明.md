...
> 技术基线：v2.4.4 / CH-014（2026-08-25）；状态：B0-B5 development 已完成，B6.0 已完成并暂停，B6.1 Store 公开 API 尚未开始，staging/production 未批准
...
- CH-014 实测为 172 paths / 196 operations / 196 unique operationId / 312 schemas / 691 schema refs / 2,577 local refs / 0 dangling refs；Store SKU/Product 售罄布尔投影、COMPREHENSIVE/HOT/NEWEST/价格排序、商品名搜索、无分页公开品牌/分类、首页四区状态与 HMAC IP 限流已纳入 B6.0 契约门禁。B6.1 业务代码尚未开始。
