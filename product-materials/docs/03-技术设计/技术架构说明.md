...
> 技术基线：v2.4.4 / CH-014（2026-08-26）；状态：B0-B6 development 已完成，B6 最终 SHA `9d8911934a5aa2b09ece2e12935bcafc9ccdcba6` 的普通 CI Run `32953444096` 与 Supabase rollback-only Run `32954611250` 同 SHA 双绿，真实纵向、数据库 full、五视口 E2E 与 rollback-only 均成功，B6 development `GO`；staging/production 未批准
...
- B5 实现基准 SHA `d97c43958142eaa0fa5a0a9954bb21d136944ba2` 的普通 CI Run `32822780209` 与 Supabase development rollback-only Run `32823898006` 为同一 SHA 双绿。CH-013 只接续 B6 脱敏 development 的单人维护补偿控制，现已随 B6.4 自动失效，且从未放行 staging/production。
