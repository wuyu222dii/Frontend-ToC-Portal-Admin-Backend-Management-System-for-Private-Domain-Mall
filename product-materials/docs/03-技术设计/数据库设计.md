...
| 状态 | B0-B9 development 已完成并维持 `GO`；B10.3 已在准确 SHA `524ffe84cc6e88d0e0b6b1fb9c132a9dc752317f` 通过 CI `33288346901`、development migration `33290094491` 与 rollback-only smoke `33290244592`；B10.4 迟到支付与全额自动退款已完成本地实现、真实 `mall_runtime` rollback 验收与 `P0=0/P1=0` 复审，远端三项证据 pending。B10 不得 `GO`，CH-021 继续有效。staging、production 与真实支付均为 `NO-GO` |
| 更新时间 | 2026-08-30 |
...
CH-022/CH-023 数据库结论：现有 76 models / 59 enums 足以承载 B10，不增表、列或枚举。0003 只增加两个支付事实条件唯一索引；0004 只替换触发器函数并保持 SECURITY INVOKER 和运行角色最小权限。B10.3 已在准确 SHA `524ffe84cc6e88d0e0b6b1fb9c132a9dc752317f` 通过 CI `33288346901`、development migration `33290094491`、rollback-only smoke `33290244592`；B10.4 不新增迁移，真实 `mall_runtime` rollback 成功/失败退款路径均通过且无残留，远端证据 pending，B10 不得 `GO`，CH-021 继续有效。
