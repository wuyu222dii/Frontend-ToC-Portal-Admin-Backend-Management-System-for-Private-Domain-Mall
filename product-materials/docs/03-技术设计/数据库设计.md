...
| 状态 | B0-B8 development 已完成；B8 最终 SHA 已同 SHA 双绿，CH-017 已失效；CH-019/CH-020 已批准；B9.0-B9.4 已在本地完成，B9.4 达到 `P0=0/P1=0` 后暂停在 B9.5 前；B9 development 尚未 `GO`，staging/production 未批准 |
| 更新时间 | 2026-08-28 |
