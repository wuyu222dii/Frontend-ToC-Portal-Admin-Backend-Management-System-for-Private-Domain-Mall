...
| 状态 | B0-B6 development 已完成；CH-014 未修改逻辑模型或首迁移，B6 最终 SHA `9d8911934a5aa2b09ece2e12935bcafc9ccdcba6` 已通过隔离 PostgreSQL full、真实纵向、普通 CI 与受控 Supabase rollback-only 同 SHA 双绿，B6 development `GO`；staging/production 未批准 |
| 更新时间 | 2026-08-26 |
