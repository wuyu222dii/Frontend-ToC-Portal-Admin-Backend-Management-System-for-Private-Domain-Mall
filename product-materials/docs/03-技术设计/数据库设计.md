...
| 状态 | B0-B6 development 已完成；CH-015/CH-016 已批准，B7.0-B7.4 已完成并按批暂停，B7.5 已获准并完成小程序工程实现，本地自动化验收与最终只读复审已通过 `P0=0/P1=0`，等待同 SHA 远端双绿，B7 development 尚不可标记 `GO`；CH-016 不修改逻辑模型或首迁移，staging/production 未批准 |
| 更新时间 | 2026-08-27 |
