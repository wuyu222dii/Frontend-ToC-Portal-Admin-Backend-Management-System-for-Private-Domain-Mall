...
|---|---|
| 文档版本 | v2.4.3 |
| 对应基线 | MVP/PRD v2.4.3、CH-001 至 CH-012 |
| 数据库 | Supabase 托管 PostgreSQL，生产时间统一为 UTC |
| ORM | Prisma 7.9.1，76 个实体、59 个枚举的字段级逻辑草案见 `schema.prisma` |
| 状态 | CH-012 未修改逻辑模型或首迁移；B5.1 Banner 与 B5.2 Inventory repository 已分别通过 PostgreSQL 18.3 full 门禁，B5.2 另通过 Supabase development rollback-only；B5.3 前端未改数据库并已验收暂停，B5.4 与 staging/production 未批准 |
| 更新时间 | 2026-08-25 |
