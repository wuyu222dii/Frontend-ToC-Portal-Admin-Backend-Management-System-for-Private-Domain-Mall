...
| 状态 | CH-012 未修改逻辑模型或首迁移；B5.1 Banner 与 B5.2 Inventory repository 已分别通过 PostgreSQL 18.3 full 门禁，B5.2 另通过 Supabase development rollback-only 并暂停；B5.3 与 staging/production 未批准 |
| 更新时间 | 2026-08-25 |
