...
| 状态 | B0-B6 development 已完成；CH-015/CH-016 已批准，B7.1 后端身份与会话批次已完成并暂停、`P0=0/P1=0`，B7.2 未准入；CH-016 不修改逻辑模型或首迁移，staging/production 未批准 |
| 更新时间 | 2026-08-27 |
