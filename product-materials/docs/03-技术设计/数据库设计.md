...
| 状态 | B0-B7 development 已完成；B7 最终 SHA `3f844bfb9866854ceedb975ad0dc4fd7cacfb04a` 的普通 CI Run `33055090596` 与 Supabase development rollback-only Run `33056078437` 双绿，B7 development `GO`，CH-015 已失效；CH-017/CH-018 已批准，当前只完成 B8.0 契约与治理并暂停；CH-018 不修改逻辑模型或两份首迁移，staging/production 未批准 |
| 更新时间 | 2026-08-27 |
