...
| 状态 | B0-B9 development 已完成并维持 `GO`；当前只实施 B10.0。`0003_b10_payment_fact_indexes` 的本地完整迁移回放、权限和 diff 门禁已通过；普通 CI、Supabase development migration 与 rollback-only smoke 仍待精确 SHA 远端证据，B10.1 尚未开始。staging、production 与真实支付均为 `NO-GO` |
| 更新时间 | 2026-08-29 |
