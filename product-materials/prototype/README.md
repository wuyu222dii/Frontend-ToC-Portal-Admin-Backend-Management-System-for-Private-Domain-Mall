...
当前产品/API 基线为 v2.4.9/CH-024。B0-B11 development `GO`；B11 最终同 SHA 普通 CI 与 Supabase rollback-only smoke 双绿已闭合，CH-025 已自动失效。当前目录的 MP-10/11/12、ADM-09/10/11 画板仅为静态参考，不构成 B11 工程能力、真实客户数据、真实物流/资金链路或 staging/production 的验收证据。
