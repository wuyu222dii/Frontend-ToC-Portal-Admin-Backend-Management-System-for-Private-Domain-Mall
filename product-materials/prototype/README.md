...
当前产品/API 基线为 v2.4.3/CH-012。ADM-07 Banner 与 ADM-08 库存原型已按冻结契约完成同步，并通过五视口与关键交互回归；B5.1/B5.2 已分别完成 Banner 与 Inventory 后端验收，但这些结果不替代 B5.3 工程前端、最终远端 workflow 或生产验收。
