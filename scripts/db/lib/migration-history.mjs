...
export const B15_MIGRATION_HISTORY_SQL = `SELECT concat_ws('|',
  count(*),
  count(*) FILTER (
    WHERE migration_name = '0001_initial'
      AND checksum = 'f1e192fc6a93710e855770a27ed2de04665288fd9ab188652c0fd5f7683ba71b'
...
export const B15_DEPLOYED_HISTORY = "7|1|1|1|1|1|1|1|0|0";
export const B15_PREDECESSOR_HISTORY = "6|1|1|1|1|1|1|0|0|0";

export function isApprovedB15Predecessor(history) {
  return history === B15_PREDECESSOR_HISTORY || history === B15_DEPLOYED_HISTORY;
}

export function isExactB15History(history) {
  return history === B15_DEPLOYED_HISTORY;
}
